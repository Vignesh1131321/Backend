 ...
 */
@Component
 public class Resident extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("resident");
	...
	static {
		...
		metaData.setTableName("resident");

		metaData.setCluster("traveler_db");
	}

	public Resident() {this.setId(Util.getUniqueId());}
	public Resident(String id) {this.setId(id);}

	public Resident(Resident obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return ResidentResult.class;};
	public  Class<?> getMessageClass() {return ResidentMessage.class;};
	public  Class<?> getHelperClass() {return ResidentHelper.class;};
	public  Class<?> getServiceClass() {return ResidentService.class;};
}