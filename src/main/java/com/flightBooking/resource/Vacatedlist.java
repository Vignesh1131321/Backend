 ...
 */
@Component
 public class Vacatedlist extends BaseResource {
	...
	public static String FIELD_DATEOFVACATION = "dateofvacation";
	...
	public static String FIELD_REMARKSCHECKOUT = "remarkscheckout";
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("vacatedlist");
	...
	static {
		...
		Field dateofvacationField = new Field("dateofvacation", "String");
		dateofvacationField.setRequired(true);
		dateofvacationField.setForeign(new Foreign("Allotment"));
		metaData.addField(dateofvacationField);

		Field newroomnumberField = new Field("newroomnumber", "String");
		newroomnumberField.setForeign(new Foreign("Allotment"));
		metaData.addField(newroomnumberField);

		Field oldroomnumberField = new Field("oldroomnumber", "String");
		oldroomnumberField.setForeign(new Foreign("Allotment"));
		metaData.addField(oldroomnumberField);

		Field isshiftField = new Field("isshift", "Boolean");
		isshiftField.setForeign(new Foreign("Allotment"));
		metaData.addField(isshiftField);

		Field remarkscheckoutField = new Field("remarkscheckout", "String");
		metaData.addField(remarkscheckoutField);
		...
		Field checkindateField = new Field("checkindate", "String");
		checkindateField.setForeign(new Foreign("Allotment"));
		metaData.addField(checkindateField);
		...
		metaData.setTableName("vacatedlist");

		metaData.setCluster("traveler_db");
	}

	public Vacatedlist() {this.setId(Util.getUniqueId());}
	public Vacatedlist(String id) {this.setId(id);}

	public Vacatedlist(Vacatedlist obj) {
		this.id = obj.id;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(dateofvacation != null)
			map.put("dateofvacation", dateofvacation);
		...
		if(remarkscheckout != null)
			map.put("remarkscheckout", remarkscheckout);
		if(block != null)
			map.put("block", block);
		if(roomtype != null)
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object dateofvacationObj = map.get("dateofvacation");
		if(dateofvacationObj != null)
			dateofvacation = dateofvacationObj.toString();
		...
		Object remarkscheckoutObj = map.get("remarkscheckout");
		if(remarkscheckoutObj != null)
			remarkscheckout = remarkscheckoutObj.toString();
		...
		Object checkindateObj = map.get("checkindate");
		if(checkindateObj != null)
			checkindate = checkindateObj.toString();
	...
	public String getDateofvacationEx() {
		return dateofvacation != null ? dateofvacation : "";
	}
	...
	public void unSetDateofvacation() {
		this.dateofvacation = null;
	}

	public boolean validateDateofvacation(boolean add) throws ApplicationException {
		if(add && dateofvacation == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[dateofvacation]");
		return dateofvacation != null;
	}
	...
	public String getRemarkscheckoutEx() {
		return remarkscheckout != null ? remarkscheckout : "";
	}
	...
	public void unSetRemarkscheckout() {
		this.remarkscheckout = null;
	}
	...
	public String getCheckindateEx() {
	...
	public String getRemarkcheckin() {
		return remarkcheckin;
	}

	public String getRemarkcheckinEx() {
		return remarkcheckin != null ? remarkcheckin : "";
	}

	public void setRemarkcheckin(String remarkcheckin) {
		this.remarkcheckin = remarkcheckin;
	}
	...
	public  Class<?> getResultClass() {return VacatedlistResult.class;};
	public  Class<?> getMessageClass() {return VacatedlistMessage.class;};
	public  Class<?> getHelperClass() {return VacatedlistHelper.class;};
	public  Class<?> getServiceClass() {return VacatedlistService.class;};
}